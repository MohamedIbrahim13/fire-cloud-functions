    ...
    return (
        <div className="list-group-item">
            <div className="mb-1 d-flex justify-content-between">
                <h5 className="text-info">{reply.owner}</h5>
                <small className="text-muted">{moment(reply.reply_time.toDate()).calendar()}</small>
            </div>
            <p className="mb-1">{reply.reply}</p>
            <div className="d-flex justify-content-between">
                <button type="button" className="btn" onClick={()=>{likesCall(reply.id)}}>
                    {reply.likes}
                    <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-hand-index-thumb ml-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <button type="button" className="btn">
                    Share
                    <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-share-fill ml-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
